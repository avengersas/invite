...
def main_menu():
    ...
    text = f""
    buttons = [
        [custom.Button.inline("❰𝗜𝗡𝗙𝗢❱", data="check")],
        [
            custom.Button.inline("❰𝗖𝗢𝗠𝗠𝗔𝗡𝗗𝗦❱", data="help_k_minu"),
            Button.url("❰𝗔𝗦𝗦𝗜𝗦𝗧𝗔𝗡𝗧❱", f"https://t.me/{tol}"),
        ],
        [
    ...
    if query_user_id == Config.OWNER_ID or query_user_id in Config.SUDO_USERS:
        ...
        if query.startswith("**LegendBot"):
            ...
            if not IALIVE_PIC and ALIVE_PIC:
                ...
                I_IMG = "https://telegra.ph/file/1047d0e6de436ff45d829.mp4"
            ...
            if oso is None:
                help_pic = "https://telegra.ph/file/1047d0e6de436ff45d829.mp4"
            else:
